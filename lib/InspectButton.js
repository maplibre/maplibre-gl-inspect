...
function button() {
  ...
  btn.className = 'mapboxgl-ctrl-icon maplibre-gl-ctrl-inspect';
  btn.type = 'button';
...
InspectButton.prototype.setInspectIcon = function () {
  this._btn.className = 'mapboxgl-ctrl-icon maplibre-gl-ctrl-inspect';
};

InspectButton.prototype.setMapIcon = function () {
  this._btn.className = 'mapboxgl-ctrl-icon maplibre-gl-ctrl-map';
};
